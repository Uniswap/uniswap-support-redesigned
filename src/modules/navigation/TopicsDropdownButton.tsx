      ...
      <Menu>
        ...
        <MenuItems
          ...
          className={cn("z-modal space-y-1 rounded-large border p-2", {
            "border-dark-surface-3 bg-dark-surface-1 shadow-dark-medium":
              theme === "dark",
            "border-light-surface-3 bg-light-surface-1 shadow-light-medium":
              theme === "light",
          })}
        >
          {globalSettings.navigationTopics &&
          globalSettings.navigationTopics.length > 0
