...
export const ArticleBreadcrumbs: FC<Props> = ({ articlePageData }) => {
  return (
    <>
      <div className="ArticleBreadcrumbs mb-8 flex flex-row items-center overflow-scroll col-span-4 sm:col-span-8 relative pr-6">
      ...
      {/* Shade for the overflowing right side of the breadcrumbs */}
      <div className="w-6 h-full bg-gradient-to-r from-transparent to-light-surface-1 dark:to-dark-surface-1 absolute right-0 top-0" />
    </>
  );
};
