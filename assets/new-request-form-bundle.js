...
function Input({ field, onChange }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { className: "custom-form-field-layout", children: [jsxRuntimeExports.jsxs(Label, { className: "custom-title", children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), jsxRuntimeExports.jsx(Input$1, { name: name, type: inputType, defaultValue: value && value !== '' ? value : '', placeholder: `Enter ${label}`, validation: error ? 'error' : undefined, required: required, onChange: (e) => {
                    onChange && onChange(e.target.value);
                }, autoComplete: autocomplete, className: "custom-input", ...stepProp }), error && jsxRuntimeExports.jsx(Message, { validation: "error", children: error }), description && jsxRuntimeExports.jsx(Hint, { dangerouslySetInnerHTML: { __html: description } })] }));
}
  ...
  return jsxRuntimeExports.jsxs(Field, {
    ...
    children: [
      jsxRuntimeExports.jsxs(Label, {
        ...
        children: [
          label,
          required && jsxRuntimeExports.jsx(Span, { 'aria-hidden': 'true', children: '*' }),
        ],
      }),
      ...
      error && jsxRuntimeExports.jsx(Message, { validation: 'error', children: error }),
      description &&
        jsxRuntimeExports.jsx(Hint, { dangerouslySetInnerHTML: { __html: description } }),
    ],
  });
}
...
function TextArea({ field, hasWysiwyg, baseLocale, hasAtMentions, userRole, brandId, onChange, }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { className: "custom-form-field-layout", children: [jsxRuntimeExports.jsxs(Label, { className: "custom-title", children: [label, required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), jsxRuntimeExports.jsx(Textarea, { ref: ref, name: name, defaultValue: value && value !== '' ? value : '', placeholder: "Describe your issue.", validation: error ? 'error' : undefined, required: required, onChange: (e) => onChange(e.target.value), rows: 6, isResizable: true }), error && jsxRuntimeExports.jsx(StyledMessage, { validation: "error", children: error }), description && (jsxRuntimeExports.jsx(Hint, { className: "custom-hint", dangerouslySetInnerHTML: { __html: description } }))] }));
}

function EmptyValueOption() {
    const { t } = useTranslation();
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "Select an option" }), jsxRuntimeExports.jsx(Span, { hidden: true, children: t("new-request-form.dropdown.empty-option", "Select an option") })] }));
}
...
function TextArea({ field, hasWysiwyg, baseLocale, hasAtMentions, userRole, brandId, onChange }) {
  ...
  return jsxRuntimeExports.jsxs(Field, {
    ...
    children: [
      ...
      error && jsxRuntimeExports.jsx(StyledMessage, { validation: 'error', children: error }),
      description &&
...
function EmptyValueOption() {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      jsxRuntimeExports.jsx(Span, { 'aria-hidden': 'true', children: 'Select an option' }),
...
function DropDown({ field, onChange }) {
  ...
  return jsxRuntimeExports.jsxs(Field$1, {
    ...
    children: [
      ...
      error && jsxRuntimeExports.jsx(Message$1, { validation: 'error', children: error }),
      description &&
        jsxRuntimeExports.jsx(Hint$1, { dangerouslySetInnerHTML: { __html: description } }),
    ],
  });
}
...
function Checkbox({ field, onChange }) {
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [
      jsxRuntimeExports.jsx('input', { type: 'hidden', name: name, value: 'off' }),
  ...
  options.forEach((option) => {
    ...
    if (!name.includes('::')) {
      ...
      for (let i = 0; i < groupNames.length; i++) {
        ...
        if (
          result[parentGroupIdentifier]?.options.find((o) => o.value === nextGroupIdentifier) ===
          undefined
        ) {
          result[parentGroupIdentifier]?.options.push({
            type: 'next',
...
`;
function RelatedArticles({ field }) {
    const { options, required, description } = field;
    return options.length > 0 ? (jsxRuntimeExports.jsx(Container$1, { "data-test-id": "suggested-articles", className: "!mt-6", children: jsxRuntimeExports.jsxs(InnerContainer, { children: [jsxRuntimeExports.jsxs(Label, { className: "custom-title", children: [jsxRuntimeExports.jsx("span", { children: "Related Articles" }), required && jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), description && (jsxRuntimeExports.jsx(Hint, { className: "custom-hint", dangerouslySetInnerHTML: { __html: description } })), jsxRuntimeExports.jsx("div", { className: "sm:grid grid-cols-3 gap-4 mt-3 flex flex-row flex-nowrap overflow-x-scroll sm:overflow-x-hidden", children: options.map((option, index) => {
                        if (index <= 2) {
                            return (jsxRuntimeExports.jsx(ListItem, { className: "col-span-1 !min-h-[7.5rem] list-none !rounded-[1.25rem] w-3/4 shrink-0 sm:w-full", children: jsxRuntimeExports.jsx(Anchor, { href: option.value, className: "hover:!no-underline", target: "_blank", children: jsxRuntimeExports.jsxs("div", { className: "col-span-1 !bg-light-accent-2 dark:!bg-dark-accent-2 hover:!bg-light-accent-2-hovered hover:dark:!bg-dark-accent-2-hovered !body-2 !text-light-accent-1 hover:!text-light-accent-1-hovered hover:dark:!text-dark-accent-1-hovered dark:!text-dark-accent-1 !min-h-[7.5rem] list-none !p-4 !rounded-[1.25rem] flex flex-col justify-between hover:!no-underline", children: [jsxRuntimeExports.jsx(Book, {}), jsxRuntimeExports.jsx("p", { children: option.name })] }) }) }, option.value));
                        }
                        else {
                            return null;
                        }
        ...
        children: jsxRuntimeExports.jsxs(InnerContainer, {
          children: [
            jsxRuntimeExports.jsxs(Label, {
              className: 'custom-title',
              children: [
                jsxRuntimeExports.jsx('span', { children: 'Related Articles' }),
                required && jsxRuntimeExports.jsx(Span, { 'aria-hidden': 'true', children: '*' }),
              ],
            }),
            description &&
                    ...
                    ListItem,
                    {
                      ...
                      children: jsxRuntimeExports.jsx(Anchor, {
                        ...
                        children: jsxRuntimeExports.jsxs('div', {
                          ...
                          children: [
                            jsxRuntimeExports.jsx(Book, {}),
                            jsxRuntimeExports.jsx('p', { children: option.name }),
                          ],
                        }),
                      }),
                    },
...
function TicketFormField({ field, newRequestPath }) {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      jsxRuntimeExports.jsx('input', { type: 'hidden', name: field.name, value: field.value }),
...
function FileListItem({ file, onRemove, }) {
    ...
    return (jsxRuntimeExports.jsx(FileList.Item, { children: jsxRuntimeExports.jsx(File$1, { type: "generic", title: fileName, onKeyDown: handleFileKeyDown, children: file.status === "pending" ? (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(FileNameWrapper, { children: fileName }), jsxRuntimeExports.jsx(Tooltip, { content: stopUploadLabel, children: jsxRuntimeExports.jsx(File$1.Close, { "aria-label": stopUploadLabel, onClick: () => {
                                onRemove();
                            }, onKeyDown: handleCloseKeyDown }) }), jsxRuntimeExports.jsx(Progress, { value: file.progress, "aria-label": t("new-request-form.attachments.uploading", "Uploading {{fileName}}", { fileName }) })] })) : (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(FileNameWrapper, { children: jsxRuntimeExports.jsx(Anchor, { isExternal: true, href: file.value.url, target: "_blank", children: fileName }) }), jsxRuntimeExports.jsx(Tooltip, { content: removeFileLabel, children: jsxRuntimeExports.jsx(File$1.Delete, { "aria-label": removeFileLabel, onClick: () => {
                                onRemove();
...
function Attachments({ field }) {
    ...
    return (jsxRuntimeExports.jsxs(Field, { className: "custom-form-field-layout", children: [jsxRuntimeExports.jsx(Label, { className: "custom-title", children: label }), error && jsxRuntimeExports.jsx(Message, { validation: "error", children: error }), jsxRuntimeExports.jsxs(FileUpload, { ...getRootProps(), isDragging: isDragActive, className: "!border-0 !bg-light-surface-3 dark:!bg-dark-surface-3 !rounded-xl !py-3 flex flex-row space-x-4 !px-4", children: [jsxRuntimeExports.jsx(File, {}), isDragActive ? (jsxRuntimeExports.jsx("span", { children: t("new-request-form.attachments.drop-files-label", "Drop files here") })) : (jsxRuntimeExports.jsx("span", { className: "button-label-2 !text-light-neutral-1 dark:!text-dark-neutral-1", children: t("new-request-form.attachments.choose-file-label", "Add file or drop files here") })), jsxRuntimeExports.jsx(Input$1, { ...getInputProps() })] }), files.map((file) => (jsxRuntimeExports.jsx(FileListItem, { file: file, onRemove: () => {
                    handleRemove(file);
...
function FileListItem({ file, onRemove }) {
  ...
  return jsxRuntimeExports.jsx(FileList.Item, {
    children: jsxRuntimeExports.jsx(File$1, {
      type: 'generic',
      title: fileName,
          ...
          ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                ...
                jsxRuntimeExports.jsx(Tooltip, {
                  ...
                  children: jsxRuntimeExports.jsx(File$1.Close, {
          ...
          : jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [
                ...
                jsxRuntimeExports.jsx(Tooltip, {
                  ...
                  children: jsxRuntimeExports.jsx(File$1.Delete, {
                ...
                jsxRuntimeExports.jsx(Progress, { value: 100, 'aria-hidden': 'true' }),
              ],
            }),
    }),
  });
...
function useAttachedFiles(initialValue) {
  const [files, setFiles] = reactExports.useState(initialValue);
  const addPendingFile = reactExports.useCallback((id, file_name, xhr) => {
    setFiles((current) => [...current, { status: 'pending', id, file_name, progress: 0, xhr }]);
  }, []);
  const setPendingFileProgress = reactExports.useCallback((id, progress) => {
    setFiles((current) =>
      current.map((file) =>
        file.status === 'pending' && file.id === id ? { ...file, progress } : file
      )
    );
  }, []);
  const removePendingFile = reactExports.useCallback((id) => {
  ...
  const removeUploadedFile = reactExports.useCallback((id) => {
    setFiles((current) =>
      current.filter((file) => file.status !== 'uploaded' || file.value.id !== id)
    );
  }, []);
  const setUploaded = reactExports.useCallback((pendingId, value) => {
    setFiles((current) =>
      current.map((file) =>
        file.status === 'pending' && file.id === pendingId ? { status: 'uploaded', value } : file
      )
    );
  }, []);
  return {
...
function Attachments({ field }) {
  ...
  return jsxRuntimeExports.jsxs(Field, {
    className: 'custom-form-field-layout',
    children: [
      jsxRuntimeExports.jsx(Label, { className: 'custom-title', children: label }),
      error && jsxRuntimeExports.jsx(Message, { validation: 'error', children: error }),
...
function getAppliedConditions(fieldConditions, allConditions, fields) {
  return fieldConditions.filter((condition) => {
    ...
    return (
      ...
      (parentFieldConditions.length === 0 ||
        getAppliedConditions(parentFieldConditions, allConditions, fields).length > 0)
    );
  });
}
function getVisibleFields(fields, endUserConditions) {
      ...
      return [
        ...acc,
        {
          ...
          required: appliedConditions.some((condition) =>
            condition.child_fields.some((child) => child.id == field.id && child.is_required)
          ),
        },
      ];
    }
...
function DatePicker({ field, locale, valueFormat, onChange }) {
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [
      ...
      error && jsxRuntimeExports.jsx(Message, { validation: 'error', children: error }),
      jsxRuntimeExports.jsx('input', { type: 'hidden', name: name, value: formatDate(date) }),
    ],
  });
}
...
function useTagsInputContainer({
  ...
  const handleInputKeyDown = (e) => {
    ...
    if (
      tag &&
      (e.key === KEYS.SPACE || e.key === KEYS.ENTER || e.key === KEYS.TAB || e.key === KEYS.COMMA)
    ) {
      e.preventDefault();
      if (!hasTag(tag)) {
        addTag(tag);
...
<<<<<<< HEAD
    ...
    return (jsxRuntimeExports.jsxs(Field, { children: [jsxRuntimeExports.jsx(Label, { children: label }), description && jsxRuntimeExports.jsx(Hint, { children: description }), jsxRuntimeExports.jsxs(Container, { ...getContainerProps(), children: [tags.length > 0 && (jsxRuntimeExports.jsx("span", { ...getGridProps({
...
=======
  ...
  const {
    ...
    i18n: {
      ...
      removedTag: (email) =>
        t('new-request-form.cc-field.email-removed', '{{email}} has been removed', { email }),
      addedTags: (emails) =>
        t('new-request-form.cc-field.emails-added', '{{emails}} have been added', { emails }),
    },
  });
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [
              ...
              children: jsxRuntimeExports.jsx('span', {
                ...
                children: tags.map((email, index) => {
                  ...
                  return isValid
                    ? jsxRuntimeExports.jsx(
                        GridCell,
                        { ...getGridCellProps(index), children: renderTag(index, isValid, email) },
                        index
                      )
                    : jsxRuntimeExports.jsx(
                        Tooltip,
      ...
      error && jsxRuntimeExports.jsx(Message, { validation: 'error', children: error }),
      tags.map((email) =>
        jsxRuntimeExports.jsx('input', { type: 'hidden', name: name, value: email }, email)
      ),
      jsxRuntimeExports.jsx(Span, {
        hidden: true,
        ...getAnnouncementProps(),
          ...
          currentGroup.type === 'SubGroup'
            ...
            : currentGroup.options.map((option) =>
                option.value === ''
                  ? jsxRuntimeExports.jsx(
                      Option,
                      { ...option, children: jsxRuntimeExports.jsx(EmptyValueOption, {}) },
                      option.value
                    )
                  : jsxRuntimeExports.jsx(Option, { ...option }, option.value)
              ),
...
function AnswerBotModal({
  ...
  return jsxRuntimeExports.jsxs(Modal, {
    ...
    children: [
                ...
                Accordion.Section,
                {
                  children: [
                    jsxRuntimeExports.jsx(Accordion.Header, {
                      children: jsxRuntimeExports.jsx(Accordion.Label, { children: title }),
                    }),
      ...
      jsxRuntimeExports.jsx(Close$1, { 'aria-label': t('new-request-form.close-label', 'Close') }),
    ],
  });
}
...
function LookupField({ field, userId, organizationId, onChange }) {
  ...
  const fetchOptions = reactExports.useCallback(
    async (inputValue) => {
      ...
      searchParams.set('field_id', fieldId.toString());
      searchParams.set('requester_id', userId.toString());
      if (organizationId !== null) searchParams.set('organization_id', organizationId);
      setIsLoadingOptions(true);
      try {
  ...
  return jsxRuntimeExports.jsxs(Field$1, {
    children: [
      ...
      jsxRuntimeExports.jsxs(Combobox, {
        ...
        isAutocomplete: true,
        placeholder: t('new-request-form.lookup-field.placeholder', 'Search {{label}}', {
          label: label.toLowerCase(),
        }),
        onFocus: onFocus,
        onChange: handleChange,
        renderValue: () => (selectedOption ? selectedOption?.name : EMPTY_OPTION.name),
        children: [
      ...
      error && jsxRuntimeExports.jsx(Message$1, { validation: 'error', children: error }),
      jsxRuntimeExports.jsx('input', { type: 'hidden', name: name, value: selectedOption?.value }),
    ],
  });
}
...
function NewRequestForm({ requestForm, wysiwyg, newRequestPath, parentId, parentIdPath, locale, baseLocale, hasAtMentions, userRole, userId, brandId, organizations, answerBotModal, }) {
    ...
    const { t } = useTranslation();
    const defaultOrganizationId = organizations.length > 0 && organizations[0]?.id ? organizations[0]?.id?.toString() : null;
    const handleChange = reactExports.useCallback((field, value) => {
        setTicketFields(ticketFields.map((ticketField) => ticketField.name === field.name ? { ...ticketField, value } : ticketField));
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [parentId && (jsxRuntimeExports.jsx(StyledParagraph, { children: jsxRuntimeExports.jsx(Anchor, { href: parentIdPath, children: t('new-request-form.parent-request-link', 'Follow-up to request {{parentId}}', {
                        parentId: `\u202D#${parentId}\u202C`,
                    }) }) })), jsxRuntimeExports.jsxs(Form, { ref: formRefCallback, action: action, method: http_method, acceptCharset: accept_charset, noValidate: true, onSubmit: handleSubmit, children: [errors && jsxRuntimeExports.jsx(Alert, { type: "error", children: errors }), parent_id_field && jsxRuntimeExports.jsx(ParentTicketField, { field: parent_id_field }), ticket_form_field.options.length > 0 && (jsxRuntimeExports.jsx(TicketFormField, { field: ticket_form_field, newRequestPath: newRequestPath })), emailField && jsxRuntimeExports.jsx(Input, { field: emailField }, emailField.name), ccField && jsxRuntimeExports.jsx(CcField, { field: ccField }), organizationField && (jsxRuntimeExports.jsx(DropDown, { field: organizationField, onChange: (value) => {
                            handleOrganizationChange(value);
                        } }, organizationField.name)), visibleFields.map((field) => {
                        switch (field.type) {
                            case 'subject':
                                return (jsxRuntimeExports.jsxs("div", { className: "custom-form-field-layout", children: [jsxRuntimeExports.jsxs(Label, { className: "custom-title", children: ["Subject", jsxRuntimeExports.jsx(Span, { "aria-hidden": "true", children: "*" })] }), jsxRuntimeExports.jsx(Input, { field: field, onChange: (value) => handleChange(field, value) }, field.name)] }));
                            case 'text':
                            case 'integer':
                            case 'decimal':
                            case 'regexp':
                            ...
                            case 'multiselect':
                                if (field.label.includes('RA:')) {
                                    ...
                                    if (selectedTopicField &&
                                        selectedTopicField.value &&
                                        field.label.includes(selectedTopicField.value)) {
                                        return jsxRuntimeExports.jsx(RelatedArticles, { field: field });
                                    }
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      ...
      jsxRuntimeExports.jsxs(Form, {
        ...
        children: [
          errors && jsxRuntimeExports.jsx(Alert, { type: 'error', children: errors }),
          parent_id_field && jsxRuntimeExports.jsx(ParentTicketField, { field: parent_id_field }),
          ...
          emailField && jsxRuntimeExports.jsx(Input, { field: emailField }, emailField.name),
              ...
              case 'subject':
                return jsxRuntimeExports.jsxs('div', {
                  ...
                  children: [
                    ...
                    jsxRuntimeExports.jsx(
                      Input,
                      { field: field, onChange: (value) => handleChange(field, value) },
                      field.name
                    ),
                  ],
                });
              ...
              case 'lookup':
                return jsxRuntimeExports.jsx(
                  LookupField,
                  {
                    ...
                    userId: userId,
                    organizationId:
                      organizationField !== null ? organizationField.value : defaultOrganizationId,
                    onChange: (value) => handleChange(field, value),
                  },
                  field.name
                );
          ...
          attachments_field && jsxRuntimeExports.jsx(Attachments, { field: attachments_field }),
          inline_attachments_fields.map(({ type, name, value }, index) =>
            jsxRuntimeExports.jsx('input', { type: type, name: name, value: value }, index)
          ),
