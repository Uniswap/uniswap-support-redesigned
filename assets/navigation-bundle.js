...
const MobileMenuModal = ({ isOpen, close }) => {
    ...
    return (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsxs(yt, { open: isOpen, onClose: handleClose, className: "MobileMenuModal relative z-modal md:hidden", children: [jsxRuntimeExports.jsx("button", { className: cn('fixed inset-0 z-[790] bg-scrim transition duration-500', {
                        'pointer-events-none opacity-0': !isOpen,
                        'opacity-1': isOpen,
                    }), onClick: handleClose }), jsxRuntimeExports.jsx("div", { className: cn('fixed bottom-0 left-0 right-0 flex w-screen translate-y-0 items-center transition-all z-[900]', {
    ...
    return (jsxRuntimeExports.jsxs(UIProvider, { children: [jsxRuntimeExports.jsxs("nav", { className: cn('Navigation fixed top-0 left-0 right-0 z-nav flex w-screen justify-center bg-light-surface-1 dark:border-dark-surface-3 dark:bg-dark-surface-1', {
                    'border-b': !scrollIsOnTop,
                            ...
                            hidden: !mobileSearchBarIsOpen,
                                ...
                                }, className: "body-2 text-light-neutral-2 dark:text-dark-neutral-2 shrink-0 absolute right-4", children: "Cancel" })] }), jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-row items-center justify-between border-light-surface-3 px-4 py-[1.15625rem] md:px-[0.9375rem] md:py-3 md:h-[4.5rem]", children: [jsxRuntimeExports.jsx("div", { className: "flex flex-row items-center", children: jsxRuntimeExports.jsxs(LinkBase, { href: "/hc/en-us", className: "flex flex-row items-center", children: [jsxRuntimeExports.jsx(MiniUnicon, { className: "mb-[0.1875rem] h-8 w-8" }), jsxRuntimeExports.jsx("p", { className: "body-3 md:button-label-2 ml-2 text-light-accent-1 dark:text-dark-accent-1", children: "Support" })] }) }), jsxRuntimeExports.jsxs("div", { className: "md:hidden", children: [jsxRuntimeExports.jsx(ButtonBase, { onClick: () => {
                                            setMobileSearchBarIsOpen((prev) => !prev);
                                        }, className: "mr-3", children: jsxRuntimeExports.jsx(Search, { className: "h-padding-large w-padding-large" }) }), jsxRuntimeExports.jsx(ButtonBase, { id: "mobile-menu-button", onClick: () => {
                                            setMenuIsOpen((prev) => !prev);
                                        }, children: jsxRuntimeExports.jsx(Menu, { className: "h-padding-large w-padding-large" }) })] }), jsxRuntimeExports.jsxs("div", { className: "hidden md:flex", children: [jsxRuntimeExports.jsx(ThemeSwitch, {}), jsxRuntimeExports.jsx(PrimaryButton, { className: "ml-padding-small-dense !my-auto !py-0 !h-8", label: "Submit Request", href: "/hc/en-us/requests/new", color: "accent-2" })] })] })] }), jsxRuntimeExports.jsx(MobileMenuModal, { isOpen: menuIsOpen, close: () => {
                    setMenuIsOpen(false);
                } })] }));
};
